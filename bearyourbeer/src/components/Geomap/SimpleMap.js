...
const AnyReactComponent1 = () => {this.state.pins[0]};
const AnyReactComponent2 = () => {this.state.pins[1]};
const AnyReactComponent3 = () => {this.state.pins[2]};
const AnyReactComponent4 = () => {this.state.pins[3]};
const AnyReactComponent5 = () => this.state.pins[4]};
const AnyReactComponent6 = () => {this.state.pins[5]};
const AnyReactComponent7 = () => {this.state.pins[6]};
const AnyReactComponent8 = () => {this.state.pins[7]};
const AnyReactComponent9 = () => {this.state.pins[8]};
const AnyReactComponent10 = () => {this.state.pins[9]};
...
class SimpleMap extends Component {
	...
	componentWillMount() {
			if(this.state.createPins === false){
				for(let i = 1; i < 11; i++){
					this.setState.pins.push(`<svg width="42" height="35" xmlns="http://www.w3.org/2000/svg">
						<g>
						...
						<text stroke="#000" transform="matrix(13.433609008789062,0,0,10.528879165649412,-2937.271930456162,-680.633221387863) " xml:space="preserve" text-anchor="start" font-family="Georgia, Times, 'Times New Roman', serif" font-size="24" id="svg_43" y="85.15089" x="234.182731" stroke-opacity="null" stroke-width="0" fill="#ffffff">` + i +`</text>
						<defs>
