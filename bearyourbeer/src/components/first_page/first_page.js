            ...
            <div className="container_first-page">
                ...
                <div className="container">
                    <div className="content-container">
                        ...
                        <div className="bouton_geolocalise_moi_div">
                            <a className="bouton_geolocalise_moi" href="./component/page.html">Geo-Localize me !</a>
                            ...
                            <form method="post" action="traitement.php">
                                ...
                                <a className="bouton_go" href="./component/page.html">Go</a>
                                </p>
                            </form>
                        </div>
                </div>
